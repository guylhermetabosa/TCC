...
\titulo{Avaliação do impacto de uma Ferramenta de Integração Contínua na Manutenibilidade do software de uma empresa}
\autor{Guylherme Tabosa Cabral}
\local{Quixadá, Ceará}
\data{2014}
\orientador{Prof Ms. Carlos Diego Andrade de Almeida}

% TODO: Fazer para SI, CC, ES
\include{fixos/instituicao/redes}
