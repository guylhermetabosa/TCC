...
A documentação de software é uma das atividades mais importantes da atividade de manutenção, pois auxilia uma comunicação com uma equipe externa de manutenção \cite{sergio2005}. Sua importância torna-se mais evidenciada quando Wong (1995 apud SOUZA et al., 2005) afirma que que mais 50\% do esforço de evolução do software é aplicado no entendimento do programa e na fase de manutenção, sua estrutura. \citeonline{sergio2005} identificaram os artefatos mais utilizadas por mantenedores, segundo eles de vinte e quatro artefatos disponíveis, quatorze foram utilizados.
