...
O sistema de controle de versão: "	[...] combina procedimentos e ferramentas para gerenciar diferentes versões de objetos de configurações que são criadas durante o processo de engenharia de software" \citeonline[p.~927]{pressman2010}.
...
\label{fig:Branch}
\legend{Fonte:\cite{tableless2012}}
\end{figure}
...
%\subsection{Redução de Riscos com Integração Contínua}
